...
$data_file = 'http://export.yandex.ru/weather-ng/forecasts/27612.xml';   // Загружаем файл прогноза погоды для выбранного города
...
foreach ( $xml->day as $day )  {
   ...
   $get_temp_to =  $day->day_part[$i]->temperature_to;
    ...
    $out[$counter]['weather'][$i]['temp_from'] = ($get_temp_from+$get_temp_to)/2;
